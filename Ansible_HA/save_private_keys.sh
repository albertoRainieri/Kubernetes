...
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $loadbalancer1
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $loadbalancer2
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $kmaster1
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $kmaster2
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $kmaster3
ssh-keygen -f "/home/alberto/.ssh/known_hosts" -R $kworker1
